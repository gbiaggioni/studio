...
echo "2. Reinicia tu contenedor (recuerda detener y eliminar el antiguo primero):"
echo "   sudo docker run -d --restart unless-stopped --name qreasy-container --env-file ./.env.local -p 3001:3000 qreasy-app"
